...
namespace CommerceV3.Areas.Admin.Controllers
{
    ...
    public class SlidesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Image,Url,Target,IsPudlished,Position")] Slide slide)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Name,Image,Url,Target,IsPudlished,Position")] Slide slide)
        {
            if (id != slide.Id)
            {
                return NotFound();
